...
import { Heart, ShoppingBag, Users, Cross } from 'lucide-react';
    ...
    <div className="flex min-h-screen flex-col">
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Facilitamos a maternidade conectando você ao que mais importa: fé, comunidade e apoio.
              </p>
            </div>
            <div className="mt-16 grid grid-cols-1 gap-12 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-muted-foreground">
                  Participe de fóruns, estudos bíblicos e lives para tirar dúvidas e fortalecer sua fé.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-card py-8">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          &copy; {new Date().getFullYear()} ClubNath. Todos os direitos reservados.
        </div>
      </footer>
    </div>
  );
